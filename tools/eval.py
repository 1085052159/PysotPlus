...
from toolkit.visualization import draw_f1, draw_success_precision

parser = argparse.ArgumentParser(description='tracking evaluation')
parser.add_argument('--tracker_path', '-p', type=str, default="./results",
                    help='tracker result path')
parser.add_argument("--dataset_root", "-r", type=str, default="F:/dataset/OTB2015", help="evaluation dataset root")
...
parser.add_argument('--show_video_level', '-s', dest='show_video_level', default="False",
                    action='store_true')
