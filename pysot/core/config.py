...
# please note that this can not end with /
__C.RESULTS_BASE_PATH = "/home/ubuntu/PycharmProjects/Results/paper02"

# ------------------------------------------------------------------------ #
# Testing options
# ------------------------------------------------------------------------ #
__C.TEST = CN()
# pred results save path, you can specify it in config.yaml
__C.TEST.TRACKER_DIR = ""
...
# topk settings, weight means the contribution to total loss
__C.TRAIN.TOPK = CN()
__C.TRAIN.TOPK.USE_TOPK_CLS = False
__C.TRAIN.TOPK.TOPK_NUM_CLS = 35
__C.TRAIN.TOPK.WEIGHT_CLS = 0.5
__C.TRAIN.TOPK.USE_TOPK_IOU = False
__C.TRAIN.TOPK.TOPK_NUM_IOU = 35
__C.TRAIN.TOPK.WEIGHT_IOU = 0.5

__C.TRAIN.LOC_LOSS_TYPE = "l1_loss"
__C.TRAIN.INIT_WEIGHT = False
# Anchor Target
...
# this path is the root path where your training datasets are,
# you can also specify the absolute path of the training dataset in config.yaml
base_path = "/media/ubuntu/dataset_nvme/object_tracking/crop_datas"

__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = '%s/VID/crop511' % base_path
__C.DATASET.VID.ANNO = '%s/VID/train.json' % base_path
__C.DATASET.VID.FRAME_RANGE = 100
__C.DATASET.VID.NUM_USE = 100000  # repeat until reach NUM_USE

__C.DATASET.YOUTUBEBB = CN()
__C.DATASET.YOUTUBEBB.ROOT = '%s/YTB/crop511' % base_path
__C.DATASET.YOUTUBEBB.ANNO = '%s/YTB/train.json' % base_path
__C.DATASET.YOUTUBEBB.FRAME_RANGE = 3
__C.DATASET.YOUTUBEBB.NUM_USE = -1  # use all not repeat

__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = '%s/COCO/crop511' % base_path
__C.DATASET.COCO.ANNO = '%s/COCO/train2017.json' % base_path
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = -1

__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = '%s/DET/crop511' % base_path
__C.DATASET.DET.ANNO = '%s/DET/train.json' % base_path
__C.DATASET.DET.FRAME_RANGE = 1
__C.DATASET.DET.NUM_USE = -1

__C.DATASET.GOT10K = CN()
__C.DATASET.GOT10K.ROOT = '%s/GOT10K/crop511' % base_path
__C.DATASET.GOT10K.ANNO = '%s/GOT10K/train.json' % base_path
__C.DATASET.GOT10K.FRAME_RANGE = 100
__C.DATASET.GOT10K.NUM_USE = 160000

__C.DATASET.LASOT = CN()
__C.DATASET.LASOT.ROOT = '%s/LASOT/crop511' % base_path
__C.DATASET.LASOT.ANNO = '%s/LASOT/train.json' % base_path
__C.DATASET.LASOT.FRAME_RANGE = 100
__C.DATASET.LASOT.NUM_USE = 160000
...
# delta normalize, a float number, used to normalize the left, top, right, bottom distance
__C.ANCHOR.DELTA_NORMALIZE = 128.
...
__C.DEBUG = CN()
__C.DEBUG.SHOW_TEMPLATE = False
__C.DEBUG.SHOW_SEARCH_REGION = False
__C.DEBUG.FINAL_HEATMAP = CN()
__C.DEBUG.FINAL_HEATMAP.SHOW_CLS = False
__C.DEBUG.FINAL_HEATMAP.MEAN = True
__C.DEBUG.VISDOM = CN()
__C.DEBUG.VISDOM.IP = "127.0.0.1"
__C.DEBUG.VISDOM.PORT = 8097
